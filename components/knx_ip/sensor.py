...
KNXSensor = knx_ip_ns.class_("KNXSensor", sensor.Sensor, cg.Component)
KNXSensorType = knx_ip_ns.enum("KNXSensorType")
...
CONFIG_SCHEMA = sensor.sensor_schema(KNXSensor).extend({
    ...
    cv.GenerateID(CONF_KNX_ID): cv.use_id(KNXIPComponent),
